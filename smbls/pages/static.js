  ...
  content: {
    ...
    ...[{
      ...
      $propsCollection: [
        ...
        'წინამდებარე დოკუმენტი არის ორმხრივად მავალდებულებელი ხელშეკრულება, რომელიც ფორმდება მომხმარებელსა და ი/მ საბა ჩხაიძეს შორის. ი/მ საბა ჩხაიძე (ს.ნ. 01024067314) რეგისტრირებული მისამართი - ქ. თბილისი, საბურთალოს რაიონი, პეკინის გამზირი, II კვარტალი, კორპუსი 9, ბინა 5.  Შემდგომში მოხსენიებული როგორც "Archy" (არჩი)',
        'ი/მ საბა ჩხაიძე“ წინამდებარე სარგებლობის წესებსა და პირობებში, კონფიდენციალურობის პოლიტიკაში და ყველა სხვა სახელმძღვანელოსა და ინსტრუქციაში შემდგომში მოხსენიებული იქნება როგორც „Archy” (არჩი)',
        '.',
