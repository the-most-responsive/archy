  ...
  content: {
    ...
    ...[{
      ...
      $propsCollection: [
        ...
        'წინამდებარე დოკუმენტი არის ორმხრივად მავალდებულებელი ხელშეკრულება, რომელიც ფორმდება მომხმარებელსა და შპს არჩის შორის. შპს არჩი (ს.ნ. 400232798) რეგისტრირებული მისამართი - XXX.  Შემდგომში მოხსენიებული როგორც "Archy" (არჩი)',
